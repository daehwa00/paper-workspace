...
## Professional hub
- The hub uses the same shared neutral palette and 56px app header as the manuscript workspace, including the desk mark, compact brand, language, appearance, and profile controls.
- The project introduction is a page heading and toolbar, with a subtle separator. It does not float over a decorative banner.
