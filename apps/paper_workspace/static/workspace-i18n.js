(() => {
  ...
  const en = {
    ...
    '이름 또는 닉네임': 'Name or nickname', '저장하고 계속': 'Save and continue',
    '공동 편집자에게 보이는 이름과 프로필 색상입니다.': 'This name and profile color are visible to collaborators.',
    '공동저자가 구분할 수 있도록 이름이나 닉네임을 입력해 주세요. 이 브라우저에서 기억합니다.': 'Enter a name or nickname so your coauthors can identify you. This browser will remember it.',
    '기본 이름 대신 본인의 이름이나 닉네임을 입력해 주세요.': 'Enter your name or nickname instead of a default name.',
